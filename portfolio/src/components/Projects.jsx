...
export default function Projects () {
  return (
    <div className="Projects">
      <h1 className="title"> a few of my recent projects</h1>
      ...
      <div className="bbBuy">
        ...
        <p>Better Best Buy was a quick full-stackathon project created and developed by myself and three other software developers <br/> with a purpose of pushing our own limits of how quickly we could recall how to code and create an application. It was created using the MERN stack with CSS used to style the elements. <br/>This project taught me how to troubleshoot Git issues and that there's no such thign as too much communication when one is working with new people and there's a fast-approaching deadline. 
        </p>
      </div>
      <div className="snake">
        <h2>Glow Worm</h2>
        ...
        <p>Glow Worm is a javascript game application I built that is heavily inspired by the classic Nokia cell phone game "Snake". This project refined my skills in JavaScript functions and CSS flexbox. I used Figma to plan my styling and Trello to track my progress.
        </p>
      </div>    
      <div className="war">
        <span>
